export class Error {
  ...
  static QR_EMPTY = { status: 400, code: "QR_EMPTY", message: "QR코드가 없습니다." };
  static UN_AUTHORIZED = { status: 401, code: "UN_AUTHORIZED", message: "아이디, 비밀번호를 확인해주세요." };
  static AUTH_ERROR = { status: 401, code: "AUTH_ERROR", message: "인증 에러" };
  static NOT_USER_FOUND = { status: 404, code: "NOT_USER_FOUND", message: "유저 정보가 틀립니다" };
